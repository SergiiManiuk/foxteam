...
exports.scripts_min = scripts_min;
...
const src = gulp.series(clean, styles, scripts, svg);
const build_min = gulp.series(clean, styles_min, scripts_min, svg);

const build = gulp.series(src);
const watch = gulp.parallel(src, watchFiles, browserTask);

exports.watch = watch;
exports.build = build;
exports.src = src;
exports.default = build;
exports.build_min = build_min;
